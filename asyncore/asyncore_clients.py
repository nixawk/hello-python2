...
# To create an asyncore client, subclass dispatcher and provide implementations
# for creating the socket, reading, and writing. Let's examine this HTTP client
# , based on the one from he standard library documentation.
...
if __name__ == '__main__':
    ...
    clients = [
        ...
        HttpClient('http://www.exploit-db.com/')
    ]
